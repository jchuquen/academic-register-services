package co.grow.plan.academic.register.application.academicplan.period.ports.spi;
...
public interface IPeriodRepositorySPI
    extends IBasicRepositoryForBasicEntity<Period> {
}
